...
**새로 설계한 식은 없다.** 국내 부동산 실무서들이 쓰는 셈법을 그대로 옮겼다.
서로 다른 셈법에 이름을 붙여 나란히 놓았을 뿐이다.
...
def noi(p: Property) -> float:
    """순영업소득(NOI) — 안민석 103쪽의 셈법. 비율이 아니라 금액이다.
